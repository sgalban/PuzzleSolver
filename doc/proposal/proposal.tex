...
grid(4, 4) {
	...
	Then simply use the solve command, followed by the print command to see the output.
	Similar actions can be taken if the user wishes to solve a Kakuro puzzle or Magic Square.
	Alternatively, a user can build this puzzle from scratch within the library and convert it into Puzzle code functionally equivalent to that shown.
